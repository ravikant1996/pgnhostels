...
public class userlistmanagerAdapter extends RecyclerView.Adapter<userlistmanagerAdapter.ViewHolder> {

    public List<User> userList;
    static Context context;

    public userlistmanagerAdapter(Context context, List<User> userList){
        this.userList = new ArrayList<User>();
        this.context = context;
        this.userList = userList;
    }
    public static class ViewHolder extends RecyclerView.ViewHolder{
        TextView name, id, tenentId, email, phone, bedno,bid, status, roomNo;
                                              ...
                                              public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                                  try {
                                                      if (response.isSuccessful()) {
                                                          Intent intent1 = new Intent(context, dashboard_manager.class);
    ...
    @Override
    public userlistmanagerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
