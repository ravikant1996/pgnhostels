...
public class staff_list_manager_adapter extends RecyclerView.Adapter<staff_list_manager_adapter.ViewHolder> {
    public List<User> userList;
    static Context context;


    public staff_list_manager_adapter(Context context, List<User> userList) {
         ...
         status.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                       try{
                                            ...
                                            try {
                                                ...
                                                Toast.makeText(context,"catch 5"+ e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                            ApiInterface api = ApiClient.getApiService();
                                            Call<ResponseBody> call = api.clear(id1, id2, id3, aid, type);
                                            call.enqueue(new Callback<ResponseBody>() {
                                                ...
                                                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                                    try {
                                                        ...
                                                        Toast.makeText(context,"catch 3"+ e.getMessage(), Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                           ...
                                           Toast.makeText(context,"catch 2"+ e.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                })
                                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                        ...
                        Toast.makeText(context,"catch 1"+ e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    @Override
    public staff_list_manager_adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
